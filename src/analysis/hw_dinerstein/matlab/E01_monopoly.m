% calculate monopoly equilibrium (for use in entry model)
...
monop_price = zeros(num_mkt_wk,1);
...
save('../../temp/S2_monop','monop_price','mkt_week_index');
