function [obj] = E08_gmm_opt_weight_nonboot(param,g_mu,g_sigma,...
...
gvec = [mean(potential_entrant_data.S2_low)-entry_modmom1_ind,...
    mean(potential_entrant_data.S2_med)-entry_modmom2_ind,...
    mean(potential_entrant_data.S2_high)-entry_modmom3_ind,...
    mean(potential_entrant_data.cost_intercept_low)-mc_modmom1_ind,...
    mean(potential_entrant_data.cost_intercept_med)-mc_modmom2_ind,...
    mean(potential_entrant_data.cost_intercept_high)-mc_modmom3_ind];
