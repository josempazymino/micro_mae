...
def set_project_paths(ctx):
    ...
    pp['IN_DATA_IGAMI'] = 'src/original_data/data_hw_igami'
    pp['IN_DATA_COFFEE'] = 'src/original_data/data_hw_coffee'
    pp['IN_DATA_DINERSTEIN'] = 'src/original_data/data_hw_dinerstein'
    pp['IN_DATA_BEER'] = 'src/original_data/data_hw_beer'
    pp['IN_DATA_BEEF'] = 'src/original_data/data_hw_beef'
    ...
    pp['OUT_ANALYSIS_IGAMI'] = '{}/out/analysis/igami'.format(out)
    pp['OUT_ANALYSIS_COFFEE'] = '{}/out/analysis/coffee'.format(out)
    pp['OUT_ANALYSIS_DINERSTEIN'] = '{}/out/analysis/dinerstein'.format(out)
    pp['OUT_ANALYSIS_BEER'] = '{}/out/analysis/beer'.format(out)
    pp['OUT_ANALYSIS_BEEF'] = '{}/out/analysis/beef'.format(out)
    #pp['OUT_ANALYSISFM'] = '{}/out/analysisfm'.format(out)
